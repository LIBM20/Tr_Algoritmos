...
def Eliminar(dados):
    print ("\033[1:4:36mEliminar Tarefa do Assunto da Reunião\033[0m")
    ...
    if pos == -1:
        ...
        if pos1 == -1:
            ...
            if pos2 == -1:
                ...
                print(dados['Reunioes'][pos]['Assuntos'][pos1]['Tarefas'][pos2])
                op = LerNumero("1-Eliminar? 2-Cancelar a Eliminação",1,2,"inteiro")
                if op == 1:
                    del(dados['Reunioes'][pos]['Assuntos'][pos1]['Tarefas'][pos2])
